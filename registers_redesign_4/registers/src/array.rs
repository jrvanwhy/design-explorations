...
/// # Safety
/// There must be exactly `LEN` consecutive instances of `Element` in this array.
pub unsafe trait RegisterArray: Block {
...
unsafe impl<Element: Block, const LEN: usize> RegisterArray for RealRegisterArray<Element, LEN> {
